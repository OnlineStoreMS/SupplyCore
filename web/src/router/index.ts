  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'purchase-orders', name: 'PurchaseOrderList', component: () => import('../views/purchase/PurchaseOrderList.vue'), meta: { title: '采购订单' } },
        { path: 'purchase-orders/create', name: 'PurchaseOrderCreate', component: () => import('../views/purchase/PurchaseOrderForm.vue'), meta: { title: '新建采购订单' } },
        { path: 'purchase-orders/:id/edit', name: 'PurchaseOrderEdit', component: () => import('../views/purchase/PurchaseOrderForm.vue'), meta: { title: '编辑采购订单' } },
        { path: 'purchase-orders/:id', name: 'PurchaseOrderDetail', component: () => import('../views/purchase/PurchaseOrderDetail.vue'), meta: { title: '采购订单详情' } },

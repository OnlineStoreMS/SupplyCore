...
export async function uploadImage(file: File, subdir = 'po'): Promise<{ url: string; fileName: string }> {
...
export async function createPhotoUploadSession(subdir = 'po'): Promise<PhotoUploadSession> {
